(function(e) {
    ...
    "3e1e": function(e) {
        e.exports = JSON.parse('{"name":"中文 (简体)","title":"Flash ROM <small>(Power by Mokee)</small>","step1:title":"准备","step1:p1":"你需要准备以下事情：","step1:p1:li1":"一部手机</a>，并且已经刷入了 TWRP；","step1:p1:li2":"将手机重启到 TWRP 模式；","step1:unsupported:p1":"你的浏览器不支持 WebUSB API。","step1:unsupported:p2":"建议更换为最新版本的 Google Chrome。","step1:next":"继续","step2:title":"选择刷机包","step2:title:selected":"已选择: {name}","step2:title:unsupported":"浏览器不支持","step2:uploader:normal":"将刷机包拖动到此处或<a>点击选择</a>","step2:uploader:active":"将刷机包拖动到此处并放下","step2:previous":"上一步","step2:next":"继续","step3:title":"连接手机","step3:title:connected":"已连接: {name}","step3:p1":"请将手机切换到 TWRP 的 ADB Sideload 模式并连接到电脑，然后点击下面的「连接手机」按钮。在弹出的对话框中选中你的手机，并点击「连接」。","step3:p2":"如果你是在 Windows 下刷机，并且在对话框中看不到你的手机，你可能需要先安装<a href=\\"https://developer.android.com/studio/run/win-usb\\">相应的驱动程序</a>。","step3:connect":"连接手机","step3:previous":"上一步","step4:title":"刷机","step4:p1":"一切就绪，请点击「开始刷机」。","step4:flashing":"正在刷入，请稍候…","step4:start":"开始刷机","step4:previous":"上一步","step5:title":"完成","step5:p1":"恭喜，刷机已完成。如果没遇到什么错误，你现在可以重启你的手机了。<a>遇到错误？</a>","step5:reset":"完成并返回开始","hint:zip":"刷机包文件应该是 ZIP 格式","hint:sideload":"手机未处于 Sideload 模式","hint:connect":"连接失败，请重试","END":""}')
    },
    "56d7": function(e, t, s) {
        "use strict";
        s.r(t);
